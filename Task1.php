...
<?php
	...
	$name = 'Лариса';
    $city = 'Норильск, Россия';
    $profession= 'Безработная';
    $email= 'zlarra@yandex.ru';
    $phone= 12345678912;
    $birth_year=1976;
    $now_year=2022;
    $skills= [
    	'skill_name' => ['Вязание', 'Кулинария', 'Вождение', 'Программирование'],
        'level'=> [89,81,70,1]
        ];
    $work = [
    	'work' => ['OOO «Рога и копыта»', 'МАУ ДО «Центр безопасности движения»'],
        'work_period' => ['Декабрь 2005г.-Октябрь 2013г.', 'Октябрь 2014г.-Ноябрь 2021г.']
        ];
...
<hr>
	            <p class="w3-large w3-text-theme"><b><i
	                  class="fa fa-circle-o fa-fw w3-margin-right w3-text-teal"></i>Возраст</b></p>
	            <p>В годах</p>
	            ...
	            <div class="w3-light-grey w3-round-xlarge">
	              <div class="w3-round-xlarge w3-teal" style="text-align: center;">
	                <?php
	                echo floor(($now_year-$birth_year) * 365.25);
	                ?>
	              </div>
	            </div>
	            <br>
